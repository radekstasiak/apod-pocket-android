...
//    public ImageCacheManager(int maxWidth, int maxHeight){
//
...
//    }
    ...
    public static ImageCacheManager getInstance(){
        if(mInstance == null)
           ...
           // mInstance = new ImageCacheManager(ImageHelper.getDisplayWidth(context),ImageHelper.getDisplayHeight(context));
    ...
    public void init(Context context, String uniqueName, int cacheSize, CompressFormat compressFormat, int quality, CacheType type){
        ...
        this.maxWidth=ImageHelper.getDisplayWidth(context);
        this.maxHeight=ImageHelper.getDisplayHeight(context);
